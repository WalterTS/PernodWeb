...
class UsuarioActivacionSupervisorType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('tipo', \Symfony\Component\Form\Extension\Core\Type\HiddenType::class, array('data' => 'Supervisor'))
                ->add('usuario', \Symfony\Bridge\Doctrine\Form\Type\EntityType::class, [
                    'label' => false,
                    'class' => \WE\ReportBundle\Entity\Usuario::class,
                    'query_builder' => function(\Doctrine\ORM\EntityRepository $repo) use ($user, $role) {
